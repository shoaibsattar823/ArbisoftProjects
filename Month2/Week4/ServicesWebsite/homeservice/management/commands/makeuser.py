...
class Command(BaseCommand):
    help = 'Creates a new user for the site.'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                'any other required field. users created with --noinput'
        ...
        if not options['interactive']:
            try:
                ...
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    if options[field_name]:
                        ...
                        raise CommandError("You must use --%s "
                                           "with --noinput." % field_name)
            ...
            try:
                ...
                while username is None:
                    ...
                    if self.username_field.unique:
                        try:
                            ...
                            self.stderr.write("Error: That %s is"
                                              " already taken." %
                                              verbose_field_name)
                            username = None
                ...
                while password is None:
                    ...
                    try:
                        validate_password(password2, self.UserModel(
                                                            **fake_user_data))
